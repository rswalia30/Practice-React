...
// Swiggy Card
{/* <div>
    <a className="sc-ktPPKK jQaulu">
        <div className="sc-kqGoIF hGrSyZ">
            <div className="sc-cWSHoV jdRrlh">
                <div className="sc-eBMEME hkLgGF">
                    <div width="100%" height="100%" className="sc-dtInlm eNZkiz">
                        <img className="sc-koXPp fKIURO" src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/RX_THUMBNAIL/IMAGES/VENDOR/2024/6/11/4ee8bc77-ca9f-41bd-a0f3-511c70902b91_74868.JPG" alt="Burger King" />
                        <div className="sc-dtBdUo gzvYBM sc-kOPcWz fFPUzA">
                            <div className="sc-aXZVg jJrxcx sc-kOHTFB jKfDUb"></div>
                            <div className="sc-aXZVg kUePhA sc-kOHTFB jKfDUb"> ITEMS AT ₹159</div>
            ...
            <div style="margin-left: 12px;">
                <div>
                    <div className="sc-aXZVg kVQudY">Burger King</div>
                </div>
                <div className="sw-restaurant-card-subtext-container">
                    ...
                    <div className="sc-aXZVg gwlQpm" style="margin-top: -4px;">
                        <span className="sc-aXZVg kIcQre">4 • </span>25-30 mins</div>
                </div>
                <div className="sw-restaurant-card-descriptions-container">
                    <div className="sc-aXZVg klLkzp">Burgers, American</div>
                    <div className="sc-aXZVg klLkzp">East Amritsar</div>
                </div>
            </div>
        </div>
    </a>
